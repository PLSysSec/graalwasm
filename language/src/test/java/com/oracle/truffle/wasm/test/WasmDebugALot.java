...
/**
 * Basic test of debug-a-lot instrument applied to wasm language.
 */
public class WasmDebugALot {

    private final Source wasmCode = Source.create("wasm", "function main() {\n" +
                    "  n = 2;\n" +
                    "  return types(n);\n" +
                    "}\n" +
                    "function doNull() {}\n" +
