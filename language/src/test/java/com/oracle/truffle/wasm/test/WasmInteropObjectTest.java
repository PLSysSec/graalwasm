...
public class WasmInteropObjectTest {
    ...
    public void testObject() {
        final Source src = Source.newBuilder("wasm", "function main() {o = new(); o.a = 10; o.b = \"B\"; return o;}", "testObject.wasm").buildLiteral();
    ...
    public void testNewForeign() {
        final Source src = Source.newBuilder("wasm", "function getValue(type) {o = new(type); o.a = 10; return o.value;}", "testObject.wasm").buildLiteral();
        context.eval(src);
        Value getValue = context.getBindings("wasm").getMember("getValue");
