...
public class WasmSeparatedClassLoadersTest {
    ...
    @Test
    public void sdkAndTruffleLanguageAPIAndWasmInSeparateClassLoaders() throws Exception {
        ...
        URL wasmURL = WasmLanguage.class.getProtectionDomain().getCodeSource().getLocation();
        Assume.assumeNotNull(wasmURL);
        ...
        URLClassLoader wasmLoader = new URLClassLoader(new URL[]{wasmURL}, truffleLoader);
        Thread.currentThread().setContextClassLoader(wasmLoader);
        ...
        Object lang = languages.get("wasm");
        assertNotNull("Wasm language found: " + languages, lang);
    }
