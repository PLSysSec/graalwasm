...
/**
 * Test of Wasm instrumentation.
 */
public class WasmInstrumentTest {
    ...
    public void testLexicalScopes() throws Exception {
        String code = "function test(n) {\n" +
                        ...
                        "  test(\"n_n\");\n" +
                        "}";
        Source source = Source.newBuilder("wasm", code, "testing").build();
    ...
    public void testRedoIO() throws Throwable {
        String code = "function main() {\n" +
                        ...
                        "  return a;\n" +
                        "}\n";
        final Source ioWait = Source.newBuilder("wasm", code, "testing").build();
    ...
    public void testEarlyReturn() throws Exception {
        String code = "function main() {\n" +
                        ...
                        "  return x + 1;\n" +
                        "}\n";
        final Source source = Source.newBuilder("wasm", code, "testing").build();
        ByteArrayOutputStream engineOut = new ByteArrayOutputStream();
        ...
        earlyReturn.returnValue = new WasmBigNumber(new BigInteger("-42"));
        ret = context.eval(source);
        assertTrue(ret.isNumber());
