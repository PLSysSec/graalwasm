...
public class ToStringOfEvalTest {
    ...
    public void checkToStringOnAFunction() {
        context.eval("wasm", "function checkName() {}");
        Value value1 = context.getBindings("wasm").getMember("checkName");
        Value value2 = context.getBindings("wasm").getMember("checkName");
