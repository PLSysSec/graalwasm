...
public class WasmExecutionListenerTest {
    ...
    public void testFactorial() {
        ...
        String characters =
                        ...
                        "}";
        // @formatter:on
        context.eval("wasm", "function " + characters);
        Value factorial = context.getBindings("wasm").getMember("fac");
    ...
    private Value eval(String s) {
        ...
        context.eval("wasm", wrapInFunction(s));
        return context.getBindings("wasm").getMember("wrapper").execute();
    }
