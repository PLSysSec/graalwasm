...
/**
 * Exception thrown by the {@link WasmBreakNode break statement} and caught by the {@link WasmWhileNode
 ...
 */
public final class WasmBreakException extends ControlFlowException {

    public static final WasmBreakException SINGLETON = new WasmBreakException();

    private static final long serialVersionUID = -91013036379258890L;

    /* Prevent instantiation from outside. */
    private WasmBreakException() {
    }
}
