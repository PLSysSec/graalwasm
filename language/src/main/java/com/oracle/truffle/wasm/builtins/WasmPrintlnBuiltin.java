...
/**
 * Builtin function to write a value to the {@link WasmContext#getOutput() standard output}. The
...
public abstract class WasmPrintlnBuiltin extends WasmBuiltinNode {
    ...
    @Specialization
    public String println(String value, @CachedContext(WasmLanguage.class) WasmContext context) {
        doPrint(context.getOutput(), value);
        return value;
    }
