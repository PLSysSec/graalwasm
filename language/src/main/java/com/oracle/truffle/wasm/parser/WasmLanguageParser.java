...
public class WasmLanguageParser extends Parser {
	...
	public final WasmlanguageContext simplelanguage() throws RecognitionException {
	...
	public static class FunctionContext extends ParserRuleContext {
		...
		public List<TerminalNode> IDENTIFIER() { return getTokens(WasmLanguageParser.IDENTIFIER); }
		public TerminalNode IDENTIFIER(int i) {
			return getToken(WasmLanguageParser.IDENTIFIER, i);
		}
	...
	public final If_statementContext if_statement(boolean inLoop) throws RecognitionException {
		...
		try {
			...
			_localctx.then = _localctx.block = block(inLoop);
			 WasmStatementNode elsePart = null; 
			setState(111);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__12) {
	...
	public static class ExpressionContext extends ParserRuleContext {
		public WasmExpressionNode result;
	...
	public static class FactorContext extends ParserRuleContext {
		...
		public Token e;
		public TerminalNode IDENTIFIER() { return getToken(WasmLanguageParser.IDENTIFIER, 0); }
		public TerminalNode STRING_LITERAL() { return getToken(WasmLanguageParser.STRING_LITERAL, 0); }
		public TerminalNode NUMERIC_LITERAL() { return getToken(WasmLanguageParser.NUMERIC_LITERAL, 0); }
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public Member_expressionContext member_expression() {
	...
	public final FactorContext factor() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				...
				setState(177);
				_localctx.IDENTIFIER = match(IDENTIFIER);
				 WasmExpressionNode assignmentName = factory.createStringLiteral(_localctx.IDENTIFIER, false); 
				setState(183);
				_errHandler.sync(this);
	...
	public static class Member_expressionContext extends ParserRuleContext {
		public WasmExpressionNode r;
		public WasmExpressionNode assignmentReceiver;
		public WasmExpressionNode assignmentName;
		public WasmExpressionNode result;
		public ExpressionContext expression;
		public Token e;
		public Token IDENTIFIER;
		...
		public Member_expressionContext(ParserRuleContext parent, int invokingState, WasmExpressionNode r, WasmExpressionNode assignmentReceiver, WasmExpressionNode assignmentName) {
			super(parent, invokingState);
			this.r = r;
	...
	public final Member_expressionContext member_expression(WasmExpressionNode r,WasmExpressionNode assignmentReceiver,WasmExpressionNode assignmentName) throws RecognitionException {
