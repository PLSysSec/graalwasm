...
public final class WasmBigNumber implements TruffleObject, Comparable<WasmBigNumber> {
    ...
    public WasmBigNumber(BigInteger value) {
        this.value = value;
    }

    public WasmBigNumber(long value) {
    ...
    @TruffleBoundary
    public int compareTo(WasmBigNumber o) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof WasmBigNumber) {
            return value.equals(((WasmBigNumber) obj).getValue());
        }
        return false;
    }
