...
/**
 * The initial {@link RootNode} of {@link WasmFunction functions} when they are created, i.e., when
...
public class WasmUndefinedFunctionRootNode extends WasmRootNode {
    ...
    public Object execute(VirtualFrame frame) {
        throw WasmUndefinedNameException.undefinedFunction(null, getName());
    }
}
