...
/**
 * Builtin function that reads a String from the {@link WasmContext#getInput() standard input}.
 */
@NodeInfo(shortName = "readln")
public abstract class WasmReadlnBuiltin extends WasmBuiltinNode {

    @Specialization
    public String readln(@CachedContext(WasmLanguage.class) WasmContext context) {
    ...
    private String doRead(BufferedReader in) {
        try {
            ...
            throw new WasmException(ex.getMessage(), this);
        }
    }
}
