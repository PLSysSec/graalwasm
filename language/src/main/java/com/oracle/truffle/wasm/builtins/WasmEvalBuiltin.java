...
public abstract class WasmEvalBuiltin extends WasmBuiltinNode {
    ...
    public Object evalCached(String id, String code,
                    ...
                    @CachedContext(WasmLanguage.class) WasmContext context,
    ...
    public Object evalUncached(String id, String code, @CachedContext(WasmLanguage.class) WasmContext context) {
        return parse(id, code, context).call();
    }

    protected CallTarget parse(String id, String code, WasmContext context) {
