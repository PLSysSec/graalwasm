...
/**
 * Logical operations in Wasm use short circuit evaluation: if the evaluation of the left operand
 * already decides the result of the operation, the right operand must not be executed. This is
 * expressed in using this base class for {@link WasmLogicalAndNode} and {@link WasmLogicalOrNode}.
 */
public abstract class WasmShortCircuitNode extends WasmExpressionNode {

    @Child private WasmExpressionNode left;
    @Child private WasmExpressionNode right;
    ...
    public WasmShortCircuitNode(WasmExpressionNode left, WasmExpressionNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public final boolean executeBoolean(VirtualFrame frame) {
        ...
        try {
            ...
            throw WasmException.typeError(this, e.getResult(), null);
        }
        boolean rightValue;
        try {
            ...
            throw WasmException.typeError(this, leftValue, e.getResult());
        }
