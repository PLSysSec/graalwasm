...
public abstract class WasmDefineFunctionBuiltin extends WasmBuiltinNode {

    @TruffleBoundary
    @Specialization
    public String defineFunction(String code, @CachedContext(WasmLanguage.class) WasmContext context) {
        // @formatter:off
        Source source = Source.newBuilder(WasmLanguage.ID, code, "[defineFunction]").
            build();
        // @formatter:on
