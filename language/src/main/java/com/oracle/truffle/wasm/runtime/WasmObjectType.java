...
public final class WasmObjectType extends ObjectType {

    protected static final int CACHE_LIMIT = 3;
    public static final ObjectType SINGLETON = new WasmObjectType();

    private WasmObjectType() {
    }

    @Override
    public Class<?> dispatch() {
        return WasmObjectType.class;
    }
    ...
    abstract static class WriteMember {
         ...
         * {@link WasmWritePropertyCacheNode#writeNewPropertyCached} because there we perform a shape
