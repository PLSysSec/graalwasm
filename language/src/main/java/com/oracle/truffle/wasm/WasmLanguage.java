...
import com.oracle.truffle.wasm.parser.SimpleLanguageLexer;
import com.oracle.truffle.wasm.parser.SimpleLanguageParser;
...
public final class WasmLanguage extends TruffleLanguage<WasmContext> {
    ...
    protected CallTarget parse(ParsingRequest request) throws Exception {
        ...
        if (request.getArgumentNames().isEmpty()) {
            functions = SimpleLanguageParser.parseWasm(this, source);
        } else {
            ...
            functions = SimpleLanguageParser.parseWasm(this, decoratedSource);
        }
