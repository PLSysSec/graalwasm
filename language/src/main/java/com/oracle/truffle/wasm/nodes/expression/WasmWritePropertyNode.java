...
import com.oracle.truffle.wasm.nodes.util.WasmToMemberNode;
...
@NodeChild("nameNode")
@NodeChild("valueNode")
public abstract class WasmWritePropertyNode extends WasmExpressionNode {
    ...
    protected Object write(Object receiver, Object index, Object value,
        ...
        try {
            ...
            // read was not successful. In Wasm we only have basic support for errors.
            throw WasmUndefinedNameException.undefinedProperty(this, index);
        }
        return value;
    }
    ...
    protected Object write(Object receiver, Object name, Object value,
                    ...
                    @Cached WasmToMemberNode asMember) {
        try {
            objectLibrary.writeMember(receiver, asMember.execute(name), value);
        } catch (UnsupportedMessageException | UnknownIdentifierException | UnsupportedTypeException e) {
            // write was not successful. In Wasm we only have basic support for errors.
            throw WasmUndefinedNameException.undefinedProperty(this, name);
        }
        return value;
    }
