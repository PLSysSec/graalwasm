...
/**
 * The type system of Wasm, as explained in {@link WasmLanguage}. Based on the {@link TypeSystem}
 * annotation, the Truffle DSL generates the subclass {@link WasmTypesGen} with type test and type
...
public abstract class WasmTypes {
     ...
     * check that the Truffle DSL would generate. For {@link WasmNull}, we do not need an
     ...
     * specializations where a {@link WasmBigNumber} is expected. This models the semantic of Wasm: It
     * only has an arbitrary precision Number type (implemented as {@link WasmBigNumber}, and
