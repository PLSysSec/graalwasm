 ...
 */
@NodeInfo(shortName = "le_u")
public abstract class WasmLessOrEqualUnsignedNode extends WasmBinaryNode {

    @Specialization
    protected boolean le_u(int left, int right) {
    ...
    @Specialization
    protected boolean le_u(long left, long right) {
