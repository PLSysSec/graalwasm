...
public final class WasmIfNode extends WasmStatementNode {

    /**
     * The condition of the {@code if}. This in a {@link WasmExpressionNode} because we require a
    ...
    /** Statement (or {@link WasmBlockNode block}) executed when the condition is true. */
    @Child private WasmStatementNode thenPartNode;

    /** Statement (or {@link WasmBlockNode block}) executed when the condition is false. */
    @Child private WasmStatementNode elsePartNode;
    ...
    public WasmIfNode(WasmExpressionNode conditionNode, WasmStatementNode thenPartNode, WasmStatementNode elsePartNode) {
    ...
    public void executeVoid(VirtualFrame frame) {
        ...
        if (condition.profile(evaluateCondition(frame))) {
            ...
            /* Execute the else-branch (which is optional according to the Wasm syntax). */
    ...
    private boolean evaluateCondition(VirtualFrame frame) {
        try {
             ...
             * program.
             */
            throw WasmException.typeError(this, ex.getResult());
        }
    }
}
