...
/**
 * The loop body of a {@link WasmWhileNode while loop}. A Truffle framework {@link LoopNode} between
 * the {@link WasmWhileNode} and {@link WasmWhileRepeatingNode} allows Truffle to perform loop
 * optimizations, for example, compile just the loop body for long running loops.
 */
public final class WasmWhileRepeatingNode extends Node implements RepeatingNode {

    /**
     * The condition of the loop. This in a {@link WasmExpressionNode} because we require a result
     ...
     */
    @Child private WasmExpressionNode conditionNode;

    /** Statement (or {@link WasmBlockNode block}) executed as long as the condition is true. */
    ...
    public WasmWhileRepeatingNode(WasmExpressionNode conditionNode, WasmStatementNode bodyNode) {
        this.conditionNode = WasmUnboxNodeGen.create(conditionNode);
    ...
    public String toString() {
        return WasmStatementNode.formatSourceSection(this);
    }
