...
/**
 * Built-in function to create a new object. Objects in Wasm are simply made up of name/value pairs.
 */
@NodeInfo(shortName = "new")
public abstract class WasmNewObjectBuiltin extends WasmBuiltinNode {

    @Specialization
    @SuppressWarnings("unused")
    public Object newObject(WasmNull o, @CachedContext(WasmLanguage.class) WasmContext context,
    ...
    public Object newObject(Object obj, @CachedLibrary("obj") InteropLibrary values) {
        try {
            ...
            throw WasmUndefinedNameException.undefinedFunction(this, obj);
        }
    }
}
