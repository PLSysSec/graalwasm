...
/**
 * The base class of all Truffle nodes for Wasm. All nodes (even expressions) can be used as
 * statements, i.e., without returning a value. The {@link VirtualFrame} provides access to the
 * local variables.
 */
@NodeInfo(language = "Wasm", description = "The abstract base node for all Wasm statements")
@GenerateWrapper
@ReportPolymorphism
public abstract class WasmStatementNode extends Node implements InstrumentableNode {
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new WasmStatementNodeWrapper(this, probe);
    }
