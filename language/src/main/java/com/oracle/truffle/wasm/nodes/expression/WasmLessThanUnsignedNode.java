...
/**
 * This class is similar to the extensively documented {@link WasmAddNode}. The only difference: the
 * specialized methods return {@code boolean} instead of the input types.
 */
@NodeInfo(shortName = "lt_u")
public abstract class WasmLessThanUnsignedNode extends WasmBinaryNode {

    @Specialization
    protected boolean lt_u(int left, int right) {
    ...
    @Specialization
    protected boolean lt_u(long left, long right) {
