...
/**
 * The Wasm type for a {@code null} (i.e., undefined) value. In Truffle, it is generally discouraged
...
public final class WasmNull implements TruffleObject {

    /**
     * The canonical value to represent {@code null} in Wasm.
     */
    public static final WasmNull SINGLETON = new WasmNull();
    ...
    /**
     * {@link WasmNull} values are interpreted as null values by other languages.
     */
    @ExportMessage
    boolean isNull() {
        return true;
