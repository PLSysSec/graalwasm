 ...
 */
@NodeInfo(shortName = "le_s")
public abstract class WasmLessOrEqualSignedNode extends WasmBinaryNode {

    @Specialization
    protected boolean le_s(int left, int right) {
        return left <= right;
    }

    @Specialization
    protected boolean le_s(long left, long right) {
        return left <= right;
    }
