...
public final class WasmBlockNode extends WasmStatementNode {
     ...
     * the loop during compilation. This allows the {@link WasmStatementNode#executeVoid} method of
    ...
    public List<WasmStatementNode> getStatements() {
