 ...
 * variables {@link WasmNodeFactory#addFormalParameter in the method prologue}.
 */
public class WasmReadArgumentNode extends WasmExpressionNode {
    ...
    public WasmReadArgumentNode(int index) {
        this.index = index;
    }
