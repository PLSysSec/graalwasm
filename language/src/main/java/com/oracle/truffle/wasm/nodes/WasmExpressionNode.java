...
/**
 * Base class for all Wasm nodes that produce a value and therefore benefit from type specialization.
 * The annotation {@link TypeSystemReference} specifies the Wasm types. Specifying it here defines the
...
public abstract class WasmExpressionNode extends WasmStatementNode {
    ...
    /**
     * When we use an expression at places where a {@link WasmStatementNode statement} is already
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new WasmExpressionNodeWrapper(this, probe);
    }
