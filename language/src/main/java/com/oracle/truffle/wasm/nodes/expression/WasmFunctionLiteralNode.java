...
/**
 * Constant literal for a {@link WasmFunction function} value, created when a function name occurs as
 * a literal in Wasm source code. Note that function redefinition can change the {@link CallTarget
 * call target} that is executed when calling the function, but the {@link WasmFunction} for a name
 * never changes. This is guaranteed by the {@link WasmFunctionRegistry}.
 */
@NodeInfo(shortName = "func")
public final class WasmFunctionLiteralNode extends WasmExpressionNode {
     ...
     */
    @CompilationFinal private WasmFunction cachedFunction;
    ...
    @Override
    public WasmFunction executeGeneric(VirtualFrame frame) {
